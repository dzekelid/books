...
- name: Google Books API Get Bookshelves
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/books/master/_listings/google-books/mylibrary-bookshelves-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/books/master/_listings/google-books/mylibrary-bookshelves-get-postman.md
x-common:
- type: x-blog
